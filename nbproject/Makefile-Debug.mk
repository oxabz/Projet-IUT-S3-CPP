...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet-iut-s3-cpp

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet-iut-s3-cpp: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet-iut-s3-cpp ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Generateur.o: Generateur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generateur.o Generateur.cpp
...
${OBJECTDIR}/Generateur_nomain.o: ${OBJECTDIR}/Generateur.o Generateur.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/Generateur.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generateur_nomain.o Generateur.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/Generateur.o ${OBJECTDIR}/Generateur_nomain.o;\
	fi
