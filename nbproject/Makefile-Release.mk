...
${OBJECTDIR}/Generateur.o: Generateur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generateur.o Generateur.cpp
...
${OBJECTDIR}/Generateur_nomain.o: ${OBJECTDIR}/Generateur.o Generateur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generateur_nomain.o Generateur.cpp;\
	else  \
